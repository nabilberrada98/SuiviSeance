                                        ...
                                        <div class="panel-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="tab6primary">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-clock-o">&nbsp;</i>&nbsp;Durée de retard (min)</span>
        ...
        <script>
                                                            ...
                                                            eventRender: function (event, element) {
                                                                ...
                                                                element.click(function () {
                                                                    ...
                                                                    $.post("AjaxProcess/GestionCalendrierCours/FullInfo.php", {id: event.id}, function (data, status) {
                                                                        ...
                                                                        if (event.motif != "standard" && event.motif != null) {
                                                                ...
                                                                if (event.etat === "annulé") {
                                                                    ...
                                                                    element.css({"border": "1.3px solid orange"});
                                                    ...
                                                    function AjouterSeance(etat, motif, id_matiere, id_salle) {
                                                        if (id_matiere == '' || id_matiere == null) {
                                                            ...
                                                            $.post("AjaxProcess/GestionCalendrierCours/addEvent.php", {date_debut: addStart, date_fin: addEnd, type: '0', etat: etat, motif: motif, metadata: metadata, id_matiere: id_matiere, id_salle: id_salle}, function (data, status) {
                                                        ...
                                                        if (result) {
                                                            $.post("AjaxProcess/GestionCalendrierCours/SupprimerSeance.php", {id: EventModif.id}, function (data, status) {
                                                                if (parseInt(data) >= 1) {
                                                                    ...
                                                                    $('#calendar').fullCalendar('addEventSource', selectedFeed);
                                                                    $('#CRUDmodal').modal('hide');
                                                                    displayNotification('Séance Supprimé', 'success');
                                                                }
                                                            });
                                                        }
                                                    }
